...
var iso3166_data = [
	...
	// AN was replaced by BQ (Bonaire, Saba, Sint-Eustatius) and CW (Curaçao)
	...
	{alpha2: "AU", alpha3: "AUS", country_code: "61", country_name: "Australia", mobile_begin_with: ["4"], phone_number_lengths: [9, 10, 11, 12, 13]},
	...
	{alpha2: "BE", alpha3: "BEL", country_code: "32", country_name: "Belgium", mobile_begin_with: ["4"], phone_number_lengths: [8, 9]},
	...
	{alpha2: "SS", alpha3: "SSD", country_code: "728", country_name: "South Sudan", mobile_begin_with: ["9"], phone_number_lengths: [9]},
...
module.exports = function(phone, country, plus_sign_change) {
	var result = [];
	...
	if (plus_sign_change) {
		if (validate_phone_iso3166(phone, iso3166)) {
			...
			var phone_prefix_regex = new RegExp('^' + iso3166.country_code);
			phone = phone.replace(phone_prefix_regex, '0');
			return [phone, iso3166.alpha3];
		}
	return result;
};
